-- Migration: 012_grant_public_upsert_access.sql
-- Description: Grants INSERT, UPDATE, and ALL write policies on master, telemetry,
-- summary, and alert tables so the website application can sync directly without 403 Forbidden errors.

-- 1. Location Master Policies
...
-- 5. Device Assignment History Policies
...
-- 10. Weekly / Monthly Well Summary Policies
...
-- 11. Daily Well Health Summary Policies
...
-- 12. District Daily Summary Policies
...
-- 13. Weekly / Monthly District Summary Policies
